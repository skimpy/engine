 ...
 */
class Term extends \Skimpy\CMS\Term implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'uri', 'taxonomy', 'name', 'slug', 'contentItems'];
        }
     ...
     * {@inheritDoc}
     */
    public function getTaxonomy(): \Skimpy\CMS\Taxonomy
    {
     ...
     * {@inheritDoc}
     */
    public function addContentItem(\Skimpy\CMS\ContentItem $item)
    {
     ...
     * {@inheritDoc}
     */
    public function removeContentItem(\Skimpy\CMS\ContentItem $item)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeContentItem', [$item]);

        return parent::removeContentItem($item);
    }
